...
public class Item
{
	...
	public static void loadAvatars(main_properties prop){
		new Item(prop,"ava",87,R.drawable.icon01,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",88,R.drawable.icon02,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",89,R.drawable.icon03,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",90,R.drawable.icon04,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",91,R.drawable.icon05,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",92,R.drawable.icon06,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",93,R.drawable.icon07,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",94,R.drawable.icon08,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",95,R.drawable.icon09,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",96,R.drawable.icon10,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",97,R.drawable.icon11,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",98,R.drawable.icon12,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",99,R.drawable.icon13,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",100,R.drawable.icon14,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",101,R.drawable.icon15,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",102,R.drawable.icon16,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",103,R.drawable.icon17,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",104,R.drawable.icon18,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",105,R.drawable.icon19,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",106,R.drawable.icon20,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",107,R.drawable.icon21,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",108,R.drawable.icon22,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",109,R.drawable.icon23,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",110,R.drawable.icon24,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",111,R.drawable.icon25,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",112,R.drawable.icon26,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",113,R.drawable.icon27,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",114,R.drawable.icon28,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",115,R.drawable.icon29,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",116,R.drawable.icon30,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",117,R.drawable.icon31,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",118,R.drawable.icon32,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",119,R.drawable.icon33,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",120,R.drawable.icon34,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",121,R.drawable.icon35,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",122,R.drawable.icon36,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",123,R.drawable.icon37,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",124,R.drawable.icon38,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",125,R.drawable.icon39,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",126,R.drawable.icon40,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",127,R.drawable.icon41,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",128,R.drawable.icon42,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",129,R.drawable.icon43,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",130,R.drawable.icon44,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",131,R.drawable.icon45,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",132,R.drawable.icon46,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",133,R.drawable.icon47,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",134,R.drawable.icon48,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",135,R.drawable.icon49,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",136,R.drawable.icon50,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",137,R.drawable.icon51,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",138,R.drawable.icon52,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",139,R.drawable.icon53,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",140,R.drawable.icon54,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",141,R.drawable.icon55,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",142,R.drawable.icon56,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",143,R.drawable.icon57,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",144,R.drawable.icon58,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",145,R.drawable.icon59,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",146,R.drawable.icon60,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",147,R.drawable.icon61,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",148,R.drawable.icon62,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",149,R.drawable.icon63,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",150,R.drawable.icon64,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",151,R.drawable.icon65,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",152,R.drawable.icon66,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",153,R.drawable.icon67,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",154,R.drawable.icon68,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",155,R.drawable.icon69,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",156,R.drawable.icon70,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",157,R.drawable.icon71,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",158,R.drawable.icon72,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",159,R.drawable.icon73,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",160,R.drawable.icon74,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",161,R.drawable.icon75,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",162,R.drawable.icon76,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",163,R.drawable.icon77,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",164,R.drawable.icon78,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",165,R.drawable.icon79,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",166,R.drawable.icon80,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",167,R.drawable.icon81,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
		new Item(prop,"ava",168,R.drawable.icon82,4,prop.words.get(Words.words.armor01e),"",new String[]{"necklace"});
